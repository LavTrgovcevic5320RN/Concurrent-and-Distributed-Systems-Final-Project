...
public class BasicMessage implements Message {
    ...
    public String toString() {
        String senderIpAddressPort = "localhost" + ":" + getSenderPort();
        String receiverIpAddressPort = "localhost" + ":" + getReceiverPort();

        return "[" + ChordState.chordHash(senderIpAddressPort) + "|" + getSenderPort() + "|" + getMessageId() + "|" +
                getMessageText() + "|" + getMessageType() + "|" +
                getReceiverPort() + "|" + ChordState.chordHash(receiverIpAddressPort) + "]";
    }
